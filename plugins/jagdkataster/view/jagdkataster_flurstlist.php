  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="1" cellpadding="4">
      ...
      <tr <? if($this->flurstuecke[$i]['anteil'] < 90){ echo 'bgcolor="#E6E6F0"';}else{ echo 'bgcolor="#B4C8D2"';} ?>>
        ...
        <td style="border-left:1px solid #C3C7C3; border-bottom:1px solid #C3C7C3"><a href="index.php?go=Flurstueck_Anzeigen&jagdkataster=true&oid=<? echo $this->formvars['oid']; ?>&name=<? echo $this->formvars['name']?>&search_nummer=<? echo $this->formvars['search_nummer']; ?>&search_name=<? echo $this->formvars['search_name']; ?>&search_art=<? echo $this->formvars['search_art']; ?>&FlurstKennz=<? echo $this->flurstuecke[$i]['flurstkennz']; ?>&csrf_token=<? echo $_SESSION['csrf_token']; ?>"><? echo $this->flurstuecke[$i]['gemkgname']; ?></a></td>
        <td style="border-left:1px solid #C3C7C3; border-bottom:1px solid #C3C7C3"><a href="index.php?go=Flurstueck_Anzeigen&jagdkataster=true&oid=<? echo $this->formvars['oid']; ?>&name=<? echo $this->formvars['name']?>&search_nummer=<? echo $this->formvars['search_nummer']; ?>&search_name=<? echo $this->formvars['search_name']; ?>&search_art=<? echo $this->formvars['search_art']; ?>&FlurstKennz=<? echo $this->flurstuecke[$i]['flurstkennz']; ?>&csrf_token=<? echo $_SESSION['csrf_token']; ?>"><? echo $this->flurstuecke[$i]['flur']; ?></a></td>
        <td style="border-left:1px solid #C3C7C3; border-bottom:1px solid #C3C7C3"><a href="index.php?go=Flurstueck_Anzeigen&jagdkataster=true&oid=<? echo $this->formvars['oid']; ?>&name=<? echo $this->formvars['name']?>&search_nummer=<? echo $this->formvars['search_nummer']; ?>&search_name=<? echo $this->formvars['search_name']; ?>&search_art=<? echo $this->formvars['search_art']; ?>&FlurstKennz=<? echo $this->flurstuecke[$i]['flurstkennz']; ?>&csrf_token=<? echo $_SESSION['csrf_token']; ?>"><? echo $this->flurstuecke[$i]['zaehlernenner']; ?></a></td>
        <td width="25%" style="border-left:1px solid #C3C7C3; border-bottom:1px solid #C3C7C3"><? echo $this->flurstuecke[$i]['eigentuemer'][0]; ?>&nbsp;<? if(count_or_0($this->flurstuecke[$i]['eigentuemer']) > 1){ ?><div class="infobox"><a class="fetter" href="">...</a><div class="infotext"><? for($j=0; $j < count_or_0($this->flurstuecke[$i]['eigentuemer']); $j++){echo $this->flurstuecke[$i]['eigentuemer_nr'][$j].' '.$this->flurstuecke[$i]['eigentuemer'][$j].'<br>';} ?></div></div><? } ?></td>
