...
ALTER TABLE alkis.pp_amt
ADD COLUMN postleitzahlpostzustellung varchar,
ADD COLUMN ort_post varchar,
ADD COLUMN strasse varchar,
ADD COLUMN hausnummer varchar,
ADD COLUMN fax varchar[],
ADD COLUMN telefon varchar[],
ADD COLUMN weitereadressen varchar[];
