...
ALTER TABLE alkis.aa_projektsteuerung ALTER COLUMN inverszu_verweistauf_aa_antrag DROP NOT NULL;

ALTER TABLE alkis.aa_aktivitaet ALTER COLUMN inverszu_enthaelt_aa_vorgang DROP NOT NULL;

ALTER TABLE alkis.aa_vorgang ALTER COLUMN inverszu_enthaelt_aa_projektsteuerung DROP NOT NULL;
