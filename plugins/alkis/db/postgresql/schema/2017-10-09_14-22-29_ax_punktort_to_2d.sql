...
ALTER TABLE alkis.ax_punktortag ALTER COLUMN wkb_geometry TYPE geometry(GEOMETRY, :alkis_epsg);
ALTER TABLE alkis.ax_punktortau ALTER COLUMN wkb_geometry TYPE geometry(GEOMETRY, :alkis_epsg);
ALTER TABLE alkis.ax_punktortta ALTER COLUMN wkb_geometry TYPE geometry(GEOMETRY, :alkis_epsg);
