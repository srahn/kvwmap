...
SELECT AddGeometryColumn('alkis','ax_historischesflurstueckalb', 'objektkoordinaten', 25833, 'POINT', 2);
...
SELECT AddGeometryColumn('alkis','ax_historischesflurstueckohneraumbezug', 'objektkoordinaten', 25833, 'POINT', 2);
...
SELECT AddGeometryColumn('alkis','ax_historischesflurstueck', 'objektkoordinaten', 25833, 'POINT', 2);
...
SELECT AddGeometryColumn('alkis','ax_flurstueck', 'objektkoordinaten', 25833, 'POINT', 2);
