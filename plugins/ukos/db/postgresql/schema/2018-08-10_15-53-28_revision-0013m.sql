BEGIN;
	...
	ALTER TABLE ukos_base.punktobjekt ADD COLUMN bei_strassenelementpunkt_id CHARACTER VARYING;

	UPDATE ukos_base.punktobjekt p
	...
	ALTER TABLE ukos_base.punktobjekt
