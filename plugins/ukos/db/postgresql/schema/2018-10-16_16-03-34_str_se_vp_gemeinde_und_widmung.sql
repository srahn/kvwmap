BEGIN;
	...
	INSERT INTO ukos_base.config (key, value, default_value, type, description) VALUES
		('tolerance', 0.1, 0.1, 'numeric', 'Legt die Toleranz bei der Erzeugung der Topologie fest. Gilt auch als Fangradius für Punkte und Punkte auf Linien. Einheit in Meter');
