...
<br>
<h2>Verhältnis der Bevölkerung mit</h2>Geschlecht <select id="bevoelkerungGeschlecht" onchange="bevoelkerungShowCharts(document.getElementById('bevoelkerungChartJahrRange').value)">
...
<img id="bevoelkerungChartImage" src="plugins/bevoelkerung/img/tc_g_<?php echo $this->von_jahr; ?>.png" usemap="#tc_g_<?php echo $this->von_jahr; ?>_areas">
<?php
