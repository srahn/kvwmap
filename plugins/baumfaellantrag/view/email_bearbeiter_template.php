<?php
	...
	$mail_bearbeiter['message'] .= URL . APPLVERSION . 'index.php?Stelle_ID=' . BAUMFAELLANTRAG_STELLE_ID . '&go=Layer-Suche_Suchen&selected_layer_id=' . BAUMFAELLANTRAG_LAYER_ID_ANTRAEGE . '&value_nr=' . $antrag_id . '&operator_nr==';
	$mail_bearbeiter['message'] .= "\n";
	$mail_bearbeiter['message'] .= "\n";
