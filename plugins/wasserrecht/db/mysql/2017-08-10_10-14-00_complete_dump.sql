...
(1, 1, 'Layer-Suche_Suchen', 37, 'SELECT * FROM (SELECT a.oid AS fiswrv_gewaesserbenutzungen_umfang_oid,  a.id,  a.name,  a.wert,  a.einheit,  a.gewaesserbenutzungen as gwb_id, b.bezeichnung AS gewaesserbenutzung_link  FROM fiswrv_gewaesserbenutzungen_umfang a  LEFT JOIN fiswrv_gewaesserbenutzungen_bezeichnung b ON a.gewaesserbenutzungen = b.id WHERE 1=1) as query WHERE 1=1  AND ( (1=1))', ' ORDER BY fiswrv_gewaesserbenutzungen_umfang_oid ', 10, NULL),
