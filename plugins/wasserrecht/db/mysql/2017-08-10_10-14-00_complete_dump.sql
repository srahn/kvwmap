...
-- Generation Time: Dec 06, 2017 at 04:39 PM
...
(17, 'Behoerde', NULL, NULL, NULL, NULL, '', 5, 11, 'SELECT id, name, abkuerzung, aktuell, adresse as adress_id, art, konto as konto_id FROM fiswrv_behoerde WHERE 1=1', 'fiswrv_behoerde', 0, '', 'wasserrecht', '', '', '', '', 'name', NULL, NULL, '', 0, 'host=pgsql user=kvwmap_wr password=gdi0DVZ dbname=kvwmapsp_wr', '', 6, '', '', 'id', NULL, 10, 'pixels', '35833', '', '1', NULL, 100, NULL, NULL, NULL, '', NULL, 'epsg:35833', '', '', '', 60, '', '', '', '', '0', '0', '', '', '', '', '2', 1, '', ''),
...
(37, 'Gewaesserbenutzungen_Umfang', NULL, NULL, NULL, NULL, '', 5, 11, 'SELECT a.id, a.name, a.wert, a.einheit, a.gewaesserbenutzungen as gwb_id,b.bezeichnung AS gewaesserbenutzung_link FROM fiswrv_gewaesserbenutzungen_umfang a  LEFT JOIN fiswrv_gewaesserbenutzungen_bezeichnung b ON a.gewaesserbenutzungen = b.id WHERE 1=1', 'fiswrv_gewaesserbenutzungen_umfang', 0, '', 'wasserrecht', '', '', '', '', 'id', NULL, NULL, '', 0, 'host=pgsql user=kvwmap_wr password=gdi0DVZ dbname=kvwmapsp_wr', '', 6, '', '', 'id', NULL, 10, 'pixels', '35833', '', '1', NULL, 100, NULL, NULL, NULL, '', NULL, 'epsg:35833', '', '', '', 60, '', '', '', '', '0', '0', '', '', '', '', '2', 1, '', ''),
(50, 'Gewaesserbenutzungen_Umfang_Einheiten', NULL, NULL, NULL, NULL, '', 5, 11, 'SELECT id, name, abkuerzung  FROM fiswrv_gewaesserbenutzungen_umfang_einheiten WHERE 1=1', 'fiswrv_gewaesserbenutzungen_umfang_einheiten', 0, '', 'wasserrecht', '', '', '', '', 'name', NULL, NULL, '', 0, 'host=pgsql user=kvwmap_wr password=gdi0DVZ dbname=kvwmapsp_wr', '', 6, '', '', 'id', NULL, 10, 'pixels', '35833', '', '1', NULL, 100, NULL, NULL, NULL, '', NULL, 'epsg:35833', '', '', '', 60, '', '', '', '', '0', '0', '', '', '', '', '2', 1, '', ''),
...
(51, 'Gewaesserbenutzungen_Umfang_Name', NULL, NULL, NULL, NULL, '', 5, 11, 'SELECT id, name, abkuerzung, beschreibung  FROM fiswrv_gewaesserbenutzungen_umfang_name WHERE 1=1', 'fiswrv_gewaesserbenutzungen_umfang_name', 0, '', 'wasserrecht', '', '', '', '', 'name', NULL, NULL, '', 0, 'host=pgsql user=kvwmap_wr password=gdi0DVZ dbname=kvwmapsp_wr', '', 6, '', '', 'id', NULL, 10, 'pixels', '35833', '', '1', NULL, 100, NULL, NULL, NULL, '', NULL, 'epsg:35833', '', '', '', 60, '', '', '', '', '0', '0', '', '', '', '', '2', 1, '', ''),
(52, 'FisWrV-WRe WrZ [nicht freigegeben]', NULL, NULL, NULL, NULL, '', 5, 11, 'SELECT COALESCE(d.name,\'\') AS anlage_klasse, a.anlage AS anlage_id, b.name AS anlage_anzeige, a.id as wrz_id, COALESCE(b.id::text,\'\') ||\' -\'|| COALESCE(a.id::text,\'\') AS wrz_wid, a.ausstellbehoerde, \'\' AS ausstellbehoerde_link, a.zustaendige_behoerde,  \'\' AS zustaendige_behoerde_link, a.adressat AS personen_id, \'\' AS adressat_link, COALESCE(e.name,\'\') AS adressat_name, COALESCE(e.namenszusatz,\'\') AS adressat_namenszusatz, COALESCE(f.strasse,\'\') ||\'  \'|| COALESCE(f.hausnummer,\'\') AS adressat_strasse_hausnummer, COALESCE(f.plz::text,\'\') ||\'  \'|| COALESCE(f.ort,\'\') AS adressat_plz_ort, a.bearbeiter, \'\' AS bearbeiter_link, COALESCE(g.name,\'\') AS bearbeiter_name, COALESCE(g.namenszusatz,\'\') AS bearbeiter_namenszusatz, COALESCE(h.strasse,\'\') ||\'  \'|| COALESCE(h.hausnummer,\'\') AS bearbeiter_strasse_hausnummer, COALESCE(h.plz::text,\'\') ||\'  \'|| COALESCE(h.ort,\'\') AS bearbeiter_plz_ort, COALESCE(g.zimmer,\'\') AS bearbeiter_zimmer, COALESCE(g.telefon,\'\') AS bearbeiter_telefon, COALESCE(g.fax,\'\') AS bearbeiter_fax, COALESCE(g.email,\'\') AS bearbeiter_email,  c.bezeichnung, a.typus, a.bearbeiterzeichen, a.aktenzeichen, a.regnummer, a.bergamt_aktenzeichen, a.ort,  a.datum, a.fassung_auswahl, a.fassung_nummer, a.fassung_typus, a.fassung_bearbeiterzeichen, a.fassung_aktenzeichen, a.fassung_datum, a.gueltig_seit, a.befristet_bis, a.status, a.aktuell, CASE WHEN a.ungueltig_seit <= current_date THEN \'nein\' ELSE CASE WHEN a.befristet_bis < current_date THEN \'nein\' ELSE \'ja\' END END AS wirksam, a.ungueltig_seit, a.ungueltig_aufgrund, a.datum_postausgang,a.datum_bestand_mat, a.datum_bestand_form, a.dokument AS dokument, a.nachfolger AS nachfolger, a.vorgaenger AS vorgaenger, a.freigegeben, a.bearbeiter_name AS wrz_bearbeiter_name, a.bearbeiter_id AS wrz_bearbeiter_id, a.stelle_name, a.stelle_id, a.bearbeitungs_datum, \'\' AS wrz_ben  FROM fiswrv_wasserrechtliche_zulassungen a LEFT JOIN fiswrv_wasserrechtliche_zulassungen_bezeichnung c ON a.id = c.id LEFT JOIN fiswrv_anlagen b ON a.anlage=b.id LEFT JOIN fiswrv_anlagen_klasse d ON b.klasse=d.id LEFT JOIN fiswrv_personen e ON a.adressat=e.id LEFT JOIN fiswrv_adresse f ON e.adresse=f.id LEFT JOIN fiswrv_personen g ON a.bearbeiter=g.id LEFT JOIN fiswrv_adresse h ON g.adresse=h.id WHERE a.freigegeben = false', 'fiswrv_wasserrechtliche_zulassungen', 0, '', 'wasserrecht', '/var/www/data/wasserrecht/wrz/', '', '', '', 'name', NULL, NULL, '', 0, 'host=pgsql user=kvwmap_wr password=gdi0DVZ dbname=kvwmapsp_wr', '', 6, '', '', 'id', NULL, 10, 'pixels', '35833', '', '1', NULL, 100, NULL, NULL, NULL, '', NULL, 'epsg:35833', '', '', '', 60, '', '', '', '', '0', '0', '', '', '', '', '2', 1, '', '');
...
(9, 'abkuerzung', 'abkuerzung', 'fiswrv_personen', 'a', 'varchar', '', '', 0, 30, NULL, '', 'Text', '', '<strong>Abkürzung</strong>', NULL, NULL, NULL, NULL, 'PFLICHTFELD!  Gängie und möglichst eindeutige Abkürzung oder Kurzbezeichnung des Namens der Person (z.B. LUNG, StALU MM, EURAWASSER, REWA etc.)', 'Adressdaten', 0, 0, NULL, 0, 0, NULL, 6, 1, 0),
...
(1, 1, 1198, 802, 1, 33226427.673737, 5867814.9999175, 33466199.904656, 6051251.0619678, 2, 'zoomin', '35833', '', 'dec', 0, '2017-12-06 16:24:54', 'gui.php', 'german', '0', '0', 15, 0, 'back,forward,zoomin,zoomout,zoomall,recentre,jumpto,coord_query,query,touchquery,queryradius,polyquery,measure,', 0, 1, 0, 0, 1, 1, 0, 0, 0, 400, 150, NULL, 0, 0, '', 1, 0, 0),
(2, 2, 1198, 770, 1, 33227441.353204, 5874036.2773855, 33465502.003939, 6048886.9368076, 2, 'zoomin', '35833', NULL, 'dec', 0, '2017-12-05 15:15:07', 'gui.php', 'german', '0', '0', 15, 0, 'back,forward,zoomin,zoomout,zoomall,recentre,jumpto,coord_query,query,touchquery,queryradius,polyquery,measure', 0, 1, 0, 0, 1, 1, 0, 0, 0, 400, 150, NULL, 0, 0, '', 0, 0, 0),
...
(2, 52, '1', 100, 0, 0, '', NULL, '0', '', '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
...
(5, 12, '1', 100, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 3, '1', 100, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 41, '1', 0, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 17, '1', 100, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 49, '1', 100, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 39, '1', 0, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 24, '1', 100, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 2, '1', 100, 0, 0, '', NULL, '0', NULL, '', '', '', 0, NULL, '0', '2', 1, '0', 1),
(5, 33, '1', 100, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 38, '1', 100, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 9, '1', 0, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 25, '1', 100, -1, 0, '', NULL, '0', NULL, '', '', '', 0, NULL, '0', '2', 1, '0', 1),
(5, 34, '1', 100, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '0', 1, '0', 1),
(5, 45, '1', 100, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 37, '1', 100, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 47, '1', 100, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 36, '1', 100, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 16, '1', 100, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 6, '1', 100, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 42, '1', 100, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 43, '1', 100, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 40, '1', 0, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 1, '0', 0, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, NULL, NULL, '0', '0', 1, '0', 1),
(5, 30, '1', 100, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 10, '1', 100, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 11, '1', 100, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 13, '1', 100, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 46, '1', 100, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 44, '1', 100, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 31, '1', 100, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 48, '1', 0, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 20, '1', 100, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 26, '1', 100, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 32, '1', 100, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 14, '1', 0, 0, 0, '', NULL, '0', NULL, '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 51, '1', 100, 0, 0, '', NULL, '0', '', '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(2, 51, '1', 100, 0, 0, '', NULL, '0', '', '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(4, 51, '1', 100, 0, 0, '', NULL, '0', '', '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(1, 51, '1', 100, 0, 0, '', NULL, '0', '', '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 50, '1', 100, 0, 0, '', NULL, '0', '', '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(1, 50, '1', 100, 0, 0, '', NULL, '0', '', '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(5, 52, '1', 100, 0, 0, '', NULL, '0', '', '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(4, 25, '1', 100, 0, 0, '', NULL, '0', '', '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(4, 52, '1', 100, 0, 0, '', NULL, '0', '', '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1),
(1, 52, '1', 100, 0, 0, '', NULL, '0', '', '', NULL, NULL, 0, NULL, '0', '2', 1, '0', 1);
