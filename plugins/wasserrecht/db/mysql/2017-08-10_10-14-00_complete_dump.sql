...
(37, 'Gewaesserbenutzungen_Umfang', NULL, NULL, NULL, NULL, '', 5, 11, 'SELECT id, name, wert, einheit, gewaesserbenutzungen as gwb_id  FROM fiswrv_gewaesserbenutzungen_umfang WHERE 1=1', 'fiswrv_gewaesserbenutzungen_umfang', 0, '', 'wasserrecht', '', '', '', '', 'name', NULL, NULL, '', 0, 'host=pgsql user=kvwmap_wr password=gdi0DVZ dbname=kvwmapsp_wr', '', 6, '', '', 'id', NULL, 10, 'pixels', '35833', '', '1', NULL, 100, NULL, NULL, NULL, '', NULL, 'epsg:35833', '', '', '', 60, '', '', '', '', '0', '0', '', '', '', '', '2', 1, '', ''),
...
(37, 'wert', 'wert', 'fiswrv_gewaesserbenutzungen_umfang', 'fiswrv_gewaesserbenutzungen_umfang', 'numeric', '', '', 1, NULL, NULL, '', 'Text', '', 'Wert', NULL, NULL, NULL, NULL, '', '', 0, 0, NULL, 0, 0, NULL, 2, 1, 0),
...
(37, 'id', 'id', 'fiswrv_gewaesserbenutzungen_umfang', 'fiswrv_gewaesserbenutzungen_umfang', 'int4', '', 'PRIMARY KEY', 1, 32, 0, '', 'Text', '', '', NULL, NULL, NULL, NULL, '', '', 0, 0, NULL, -1, 0, NULL, 0, 0, 0),
(37, 'name', 'name', 'fiswrv_gewaesserbenutzungen_umfang', 'fiswrv_gewaesserbenutzungen_umfang', 'int4', '', '', 1, 32, 0, '', 'Auswahlfeld', 'SELECT id as value, name as output from wasserrecht.fiswrv_gewaesserbenutzungen_umfang_name;layer_id=51 embedded', 'Name', NULL, NULL, NULL, NULL, '', '', 0, 0, NULL, 0, 0, NULL, 1, 1, 0),
...
(37, 'einheit', 'einheit', 'fiswrv_gewaesserbenutzungen_umfang', 'fiswrv_gewaesserbenutzungen_umfang', 'int4', '', '', 0, 32, 0, '', 'Auswahlfeld', 'SELECT id as value, abkuerzung as output from wasserrecht.fiswrv_gewaesserbenutzungen_umfang_einheiten;layer_id=50 embedded', 'Einheit', NULL, NULL, NULL, NULL, '', '', 0, 0, NULL, 0, 0, NULL, 3, 1, 0),
...
(37, 'gwb_id', 'gewaesserbenutzungen', 'fiswrv_gewaesserbenutzungen_umfang', 'fiswrv_gewaesserbenutzungen_umfang', 'int4', '', '', 0, 32, 0, '', 'Auswahlfeld', 'SELECT id as value, kennnummer as output from wasserrecht.fiswrv_gewaesserbenutzungen;', 'Gewässerbenutzung', NULL, NULL, NULL, NULL, '', '', 0, 0, NULL, 0, 0, NULL, 4, 1, 0),
...
(3, 5, 1198, 770, 1, 4500873.3693108, 6001879, 4502985.6306892, 6003236, 2, 'zoomin', '25833', NULL, 'dec', 0, '0000-00-00 00:00:00', 'gui.php', 'german', '0', '0', 15, 0, 'back,forward,zoomin,zoomout,zoomall,recentre,jumpto,coord_query,query,touchquery,queryradius,polyquery,measure', 0, 1, NULL, 0, 1, 1, 0, 0, 0, 400, 150, NULL, 0, 0, '', 0, 0, 0),
...
(1, 1, 'Layer-Suche_Suchen', 38, 'SELECT * FROM (SELECT a.oid AS fiswrv_gewaesserbenutzungen_lage_oid,  COALESCE(e.name,\'\') AS anlage_klasse,  d.name as anlage_link,  d.id AS anlage_id,  c.bezeichnung AS wrz_link,  c.id AS wrz_id,  b.bezeichnung AS gewaesserbenutzungen_link,  a.id,  a.name,  a.gewaesserbenutzungen as gwb_id,  a.freigegeben,  a.the_geo,  a.bearbeiter_name ,  a.bearbeiter_id,  a.stelle_name,  a.stelle_id,  a.bearbeitungs_datum  FROM fiswrv_gewaesserbenutzungen_lage a LEFT JOIN fiswrv_gewaesserbenutzungen_bezeichnung b ON b.id = a.gewaesserbenutzungen LEFT JOIN fiswrv_wasserrechtliche_zulassungen_bezeichnung c ON b.wasserrechtliche_zulassungen = c.id LEFT JOIN fiswrv_anlagen d ON c.anlage=d.id LEFT JOIN fiswrv_anlagen_klasse e ON d.klasse=e.id WHERE 1=1) as query WHERE 1=1  AND ( (1=1)) AND (the_geo && st_transform(st_geomfromtext(\'POLYGON((33201165.000009 5867814.9999175, 33477900 5867814.9999175, 33477900 6081468, 33201165.000009 6081468, 33201165.000009 5867814.9999175))\', 35833), 35833) OR the_geo IS NULL) AND fiswrv_gewaesserbenutzungen_lage_oid = 223577', ' ORDER BY fiswrv_gewaesserbenutzungen_lage_oid ', 10, NULL),
...
(5, 'Administration', NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 201165, 5867815, 477900, 6081468, '25833', 5, '1', '30', 'Logo_GDI-Service_200x47.png', '', '', '', NULL, 'localhost', '', '', '', '', '', '', '', '', '', '', '', '', '0', '0', 6, '0', '', 0, NULL);
...
--
ALTER TABLE `layer`
  MODIFY `Layer_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
--
