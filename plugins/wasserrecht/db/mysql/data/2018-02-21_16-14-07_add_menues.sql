...
@menue_id_wasserrecht = LAST_INSERT_ID();

# Neue Untermenuepunkte zu Wasserrecht
INSERT INTO `u_menues` (`name`, `name_low-german`, `name_english`, `name_polish`, `name_vietnamese`, `links`, `onclick`, `obermenue`, `menueebene`, `target`, `order`, `title`, `button_class`) VALUES
('Neue FisWrV-WRe Anlage', '', '', '', '', concat('index.php?go=neuer_Layer_Datensatz&selected_layer_id=', @ANLAGEN_LAYER_ID), '', @menue_id_wasserrecht, 2, '', 0, '', ''),
...
('Neue FisWrV-WRe Gewässerbenutzung', '', '', '', '', concat('index.php?go=neuer_Layer_Datensatz&selected_layer_id=', @GEWAESSERBENUTZUNGEN_LAYER_ID), '', @menue_id_wasserrecht, 2, '', 3, '', ''),
('Neue FisWrV-WRe Person', '', '', '', '', concat('index.php?go=neuer_Layer_Datensatz&selected_layer_id=', @PERSONEN_LAYER_ID), '', @menue_id_wasserrecht, 2, '', 4, '', ''),
('Neue FisWrV-WRe WrZ', '', '', '', '', concat('index.php?go=neuer_Layer_Datensatz&selected_layer_id=', @WRZ_LAYER_ID), '', @menue_id_wasserrecht, 2, '', 5, '', ''),
...
($WASSERRECHT_STEELE_ENTSCHEIDER, (SELECT id FROM u_menues WHERE name like 'Wasserrecht'), 10),
($WASSERRECHT_STEELE_ENTSCHEIDER, (SELECT id FROM u_menues WHERE name like 'Neue FisWrV-WRe Anlage'), 11),
($WASSERRECHT_STEELE_ENTSCHEIDER, (SELECT id FROM u_menues WHERE links like 'index.php?go=wasserentnahmebenutzer'), 12),
($WASSERRECHT_STEELE_ENTSCHEIDER, (SELECT id FROM u_menues WHERE links like 'index.php?go=wasserentnahmeentgelt'), 13),
($WASSERRECHT_STEELE_ENTSCHEIDER, (SELECT id FROM u_menues WHERE links like 'index.php?go=Full_Extent'), 20),
($WASSERRECHT_STEELE_ENTSCHEIDER, (SELECT id FROM u_menues WHERE links like 'index.php'), 30),
($WASSERRECHT_STEELE_ENTSCHEIDER, (SELECT id FROM u_menues WHERE name like 'Suchen'), 40),
($WASSERRECHT_STEELE_ENTSCHEIDER, (SELECT id FROM u_menues WHERE links like 'index.php?go=Adresse_Auswaehlen'), 41),
($WASSERRECHT_STEELE_ENTSCHEIDER, (SELECT id FROM u_menues WHERE links like 'index.php?go=Flurstueck_Auswaehlen'), 42),
($WASSERRECHT_STEELE_ENTSCHEIDER, (SELECT id FROM u_menues WHERE links like 'index.php?go=Grundbuchblatt_Auswaehlen'), 43),
($WASSERRECHT_STEELE_ENTSCHEIDER, (SELECT id FROM u_menues WHERE links like 'index.php?go=Namen_Auswaehlen'), 44),
($WASSERRECHT_STEELE_ENTSCHEIDER, (SELECT id FROM u_menues WHERE links like 'index.php?go=Layer-Suche'), 45),
($WASSERRECHT_STEELE_ENTSCHEIDER, (SELECT id FROM u_menues WHERE links like 'index.php?go=get_last_query'), 46),
($WASSERRECHT_STEELE_ENTSCHEIDER, (SELECT id FROM u_menues WHERE name like 'Layerverwaltung'), 50),
($WASSERRECHT_STEELE_ENTSCHEIDER, (SELECT id FROM u_menues WHERE links like 'index.php?go=neuer_Layer_Datensatz'), 51),
($WASSERRECHT_STEELE_ENTSCHEIDER, (SELECT id FROM u_menues WHERE name like 'Import/Export'), 60),
($WASSERRECHT_STEELE_ENTSCHEIDER, (SELECT id FROM u_menues WHERE links like 'index.php?go=Daten_Export'), 61),
($WASSERRECHT_STEELE_ENTSCHEIDER, (SELECT id FROM u_menues WHERE links like 'index.php?go=SHP_Anzeigen'), 62);
