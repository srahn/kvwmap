...
//         		                          echo "wrz_id: ". $wrz->getId() . " i: " . $i;
                    ...
                    //     		          			     var_dump($wrz);
                        		          		...
                        		          		<td>
                        		          			<?php 
                        		          			     echo '<a href="' . $this->actual_link . '?go=' . SELECTED_LAYER_URL . '=' . $this->layer_names[GEWAESSERBENUTZUNGEN_LAYER_NAME] . '&value_' . GEWAESSERBENUTZUNGEN_OPERATOR_ID . '=' . $gewaesserbenutzung->getId() . '&operator_' . GEWAESSERBENUTZUNGEN_OPERATOR_ID . '==">' . $gewaesserbenutzung->getKennummer() . '</a>';
                        		          			?>
                        		          		</td>
                        		          		<td>
                        		          			<?php
                        		          			     echo '<a href="' . $this->actual_link . '?go=' . SELECTED_LAYER_URL . '=' . $this->layer_names[WRZ_LAYER_NAME] . '&value_' . WRZ_OPERATOR_ID . '=' . $wrz->getId() . '&operator_' . WRZ_OPERATOR_ID . '==">' . $wrz->getHinweisHTML() . '</a>';
                        		          			?>
                        		          		</td>
                        		          		<td>
                        		          			<?php
