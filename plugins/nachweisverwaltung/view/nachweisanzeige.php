...
<?
	for($i = 0; $i < count_or_0($this->nachweis->Dokumente); $i++){
		echo "nachweise.push(" . json_encode($this->nachweis->Dokumente[$i], JSON_UNESCAPED_UNICODE) . ");\n";
	}
?>
...
<!--[IF !IE]> -->
<div id="vorschau_nwv"  onmouseleave="clearVorschau();" style="z-index: 1000; position: fixed; right:200px;  top:0px; box-shadow: 12px 10px 14px rgba(0, 0, 0, 0.3);"></div>
<!-- <![ENDIF]-->
 <!--[IF IE]>
