...
<!--[IF !IE]> -->
<div id="vorschau_nwv"  onmouseleave="clearVorschau();" style="z-index: 1000; position: fixed; left:50%; margin-left:-200px;  top:0px; box-shadow: 12px 10px 14px rgba(0, 0, 0, 0.3);"></div>
<!-- <![ENDIF]-->
 <!--[IF IE]>
