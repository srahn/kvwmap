...
<!-- Transformation for Xplanung fp-files to inspire planne land use 4.0 -->
<!-- TODO zu uebertragen
FP_Bereich
FP_Plan
FP_TextAbschnitt
...
FP_Bodenschaetze
FP_BebauungsFlaeche
FP_KeineZentrAbwasserBeseitigung
...
FP_Kennzeichnung
FP_NutzunhgsbeschraenkungsFlaeche
...
FP_Gewaesser
FP_Wasserwirtschaft
ggf. weitere BP, XP o.ä. Elemente
-->
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/">
		...
		<wfs:FeatureCollection>
			...
			<wfs:member>
				<plu:SpatialPlan gml:id="{concat('GML_', generate-id(/xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan))}">
					<plu:inspireId>
						<base:Identifier>
							<!-- LocalId derzeit inspirelocalid_ + Feature-gml:id oder alternativ wird der Wert internalId aus XPlanung FP_Plan übernommen, falls dieser befüllt ist-->
							<base:localId>
								<xsl:choose>
									<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:internalId">
										<xsl:value-of select="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:internalId"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:value-of select="concat('inspirelocalid_' , generate-id(/xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan))"/>
									</xsl:otherwise>  
								</xsl:choose>
							</base:localId>
					...
					<plu:extent>
						<xsl:copy-of select="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:raeumlicherGeltungsbereich/*"/> 
					</plu:extent>
					<plu:beginLifespanVersion nilReason="unknown" xsi:nil="true" />
					<!-- officialTitle-->
					<xsl:choose> 
						<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:name">
							<plu:officialTitle>
								<xsl:apply-templates select="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:name"/>
							</plu:officialTitle>
						</xsl:when>
						<xsl:otherwise>
							<xsl:message terminate="yes">
                                Das Attribut name muss fuer xplan:FP_Plan ausgefüllt sein, um das INSPIRE-Pflichtattribut: SpatialPlan:officialTitle zu befüllen!
							</xsl:message>
						</xsl:otherwise>
					</xsl:choose>
					<!-- levelOfSpatialPlan-->
					<xsl:choose>
						<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:planArt=1000 or 
                                        xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:planArt=4000 or
                                        xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:planArt=5000">
							<plu:levelOfSpatialPlan xlink:href="http://inspire.ec.europa.eu/codelist/LevelOfSpatialPlanValue/local"/>
						</xsl:when>
						<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:planArt=2000">
							<plu:levelOfSpatialPlan xlink:href="http://inspire.ec.europa.eu/codelist/LevelOfSpatialPlanValue/supraLocal"/>
						</xsl:when>
						<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:planArt=3000">
							<plu:levelOfSpatialPlan xlink:href="http://inspire.ec.europa.eu/codelist/LevelOfSpatialPlanValue/infraRegional"/>
						</xsl:when>
						<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:planArt=9999">
							<plu:levelOfSpatialPlan xlink:href="http://inspire.ec.europa.eu/codelist/LevelOfSpatialPlanValue/other"/>
						</xsl:when>
						<xsl:otherwise>
							<xsl:message terminate="yes">
                                Das Attribut planArt muss für xplan:FP_Plan befüllt sein, um das INSPIRE-Pflichtattribut SpatialPlan:levelOfSpatialPlan zu befüllen!
							</xsl:message>
						</xsl:otherwise>
					</xsl:choose>
					...
					<!--validFrom-->
					<xsl:choose> 
						<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:wirksamkeitsDatum">
							<plu:validFrom>
								<xsl:apply-templates select="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:wirksamkeitsDatum"/>
							</plu:validFrom>
						</xsl:when>
						<xsl:otherwise>
					...
					<!--validTo-->
					<xsl:choose> 
						<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:untergangsDatum">
							<plu:validTo>
								<xsl:apply-templates select="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:untergangsDatum"/>
							</plu:validTo>
						</xsl:when>
						<xsl:otherwise>
					...
					<!-- AlternativeTitle-->
					<xsl:choose>
						<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:nummer">
							<plu:alternativeTitle>
								<xsl:apply-templates select="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:nummer"/>
							</plu:alternativeTitle>
						</xsl:when>
						<xsl:otherwise>
					...
					<xsl:choose>
						<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:planArt=1000">
							<plu:planTypeName xlink:href="5_2_FPlan"/>
						</xsl:when>
						<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:planArt=2000">
							<plu:planTypeName xlink:href="4_2_GemeinsamerFPlan"/>
						</xsl:when>
						<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:planArt=3000">
							<plu:planTypeName xlink:href="4_1_RegFPlan"/>
						</xsl:when>
						<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:planArt=4000">
							<plu:planTypeName xlink:href="5_1_FPlanRegPlan"/>
						</xsl:when>
						<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:planArt=5000">
							<plu:planTypeName xlink:href="5_3_SachlicherTeilplan"/>
						</xsl:when>
						<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:planArt=9999">
							<plu:planTypeName xlink:href="9_2_SonstigesPlanwerkStaedtebaurecht"/>
						</xsl:when>
						<xsl:otherwise>
							<xsl:message terminate="yes">
                                Das Attribut planArt muss für FP_Plan befüllt sein, um das INSPIRE-Pflichtattribut: SpatialPlan:planTypeName zu befüllen!
							</xsl:message>
						</xsl:otherwise>
					</xsl:choose>
					<!-- processStepGeneral-->
					<xsl:choose>
						<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:rechtsstand=1000 or
                                        xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:rechtsstand=2000 or
                                        xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:rechtsstand=2100 or
                                        xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:rechtsstand=2200 or
                                        xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:rechtsstand=2300 or
                                        xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:rechtsstand=2400">
							<plu:processStepGeneral xlink:href="http://inspire.ec.europa.eu/codelist/ProcessStepGeneralValue/elaboration"/>
						</xsl:when>
						<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:rechtsstand=3000">
							<plu:processStepGeneral xlink:href="http://inspire.ec.europa.eu/codelist/ProcessStepGeneralValue/adoption"/>
						</xsl:when>
						<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:rechtsstand=4000">
							<plu:processStepGeneral xlink:href="http://inspire.ec.europa.eu/codelist/ProcessStepGeneralValue/legalForce"/>
						</xsl:when>
						<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:rechtsstand=5000 or
                                        xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:rechtsstand=50000 or
                                        xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:rechtsstand=50001">
					...
					<xsl:choose>
						<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:ExterneReferenz/xplan:XP_SpezExterneReferenz/xplan:typ=1040 and
                                        xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:ExterneReferenz/xplan:XP_SpezExterneReferenz/xplan:datum and
                                        xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:ExterneReferenz/xplan:XP_SpezExterneReferenz/xplan:referenzName">
							<plu:backroundMap>
								<plu:BackgroundMapValue>
									<plu:backgroundMapDate>
										<xsl:apply-templates select="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:ExterneReferenz/xplan:XP_SpezExterneReferenz/xplan:datum"/>T00:00:00
									</plu:backgroundMapDate>
									<plu:backgroundMapReference>
										<xsl:apply-templates select="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:ExterneReferenz/xplan:XP_SpezExterneReferenz/xplan:referenzName"/>
									</plu:backgroundMapReference>
									<xsl:choose>
										<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:ExterneReferenz/xplan:XP_SpezExterneReferenz/xplan:referenzURL">
											<plu:backgroundMapURI>
												<xsl:apply-templates select="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:ExterneReferenz/xplan:XP_SpezExterneReferenz/xplan:referenzURL"/>
											</plu:backgroundMapURI>
										</xsl:when>
										<xsl:otherwise>
					...
					<!-- ordinance -->
					<xsl:choose>
						<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:technHerstellDatum or
                                        xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:genehmigungsDatum or 
                                        xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:aufstellungsbeschlussDatum or 
                                        xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:auslegungStartDatum or 
                                        xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:auslegungEndDatum or 
                                        xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:traegerbeteiligungsStartDatum or 
                                        xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:traegerbeteiligungsEndDatum or 
                                        xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:aenderungenBisDatum or 
                                        xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:entwurfsbeschlussDatum or 
                                        xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:planbeschlussDatum or 
                                        xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:hatGenerAttribut/xplan:XP_DatumAttribut
                                        ">
							<xsl:choose>
								<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:technHerstellDatum">
									<plu:ordinance>
										<plu:OrdinanceValue>
											<plu:ordinanceDate>
												<xsl:apply-templates select="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:technHerstellDatum"/>T00:00:00</plu:ordinanceDate>
							...
							<xsl:choose>
								<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:genehmigungsDatum">
									<plu:ordinance>
										<plu:OrdinanceValue>
											<plu:ordinanceDate>
												<xsl:apply-templates select="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:genehmigungsDatum"/>T00:00:00</plu:ordinanceDate>
							...
							<xsl:choose>
								<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:aufstellungsbeschlussDatum">
									<plu:ordinance>
										<plu:OrdinanceValue>
											<plu:ordinanceDate>
												<xsl:apply-templates select="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:aufstellungsbeschlussDatum"/>T00:00:00</plu:ordinanceDate>
							...
							<!-- ForEach as 0..* -->
							<xsl:for-each select="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:auslegungStartDatum">
								<plu:ordinance>
									<plu:OrdinanceValue>
										<plu:ordinanceDate>
							...
							<xsl:for-each select="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:auslegungEndDatum">
								<plu:ordinance>
									<plu:OrdinanceValue>
										<plu:ordinanceDate>
											<xsl:value-of select="."/>T00:00:00</plu:ordinanceDate>
							...
							<xsl:for-each select="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:traegerbeteiligungsStartDatum">
								<plu:ordinance>
									<plu:OrdinanceValue>
										<plu:ordinanceDate>
											<xsl:value-of select="." />T00:00:00</plu:ordinanceDate>
							...
							<xsl:for-each select="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:traegerbeteiligungsEndDatum">
								<plu:ordinance>
									<plu:OrdinanceValue>
										<plu:ordinanceDate>
											<xsl:value-of select="." />T00:00:00</plu:ordinanceDate>
							...
							<xsl:choose>
								<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:aenderungenBisDatum">
									<plu:ordinance>
										<plu:OrdinanceValue>
											<plu:ordinanceDate>
												<xsl:apply-templates select="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:aenderungenBisDatum"/>T00:00:00</plu:ordinanceDate>
											<plu:ordinanceReference>traegerbeteiligungsEndDatum</plu:ordinanceReference>
										</plu:OrdinanceValue>
									</plu:ordinance>
								</xsl:when>
							...
							<xsl:choose>
								<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:entwurfsbeschlussDatum">
									<plu:ordinance>
										<plu:OrdinanceValue>
											<plu:ordinanceDate>
												<xsl:apply-templates select="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:entwurfsbeschlussDatum"/>T00:00:00</plu:ordinanceDate>
							...
							<xsl:choose>
								<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:planbeschlussDatum">
									<plu:ordinance>
										<plu:OrdinanceValue>
											<plu:ordinanceDate>
												<xsl:apply-templates select="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:planbeschlussDatum"/>T00:00:00</plu:ordinanceDate>
							...
							<xsl:choose>
								<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:hatGenerAttribut/xplan:XP_DatumAttribut">
									<plu:ordinance>
										<plu:OrdinanceValue>
											<plu:ordinanceDate>
												<xsl:apply-templates select="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:hatGenerAttribut/xplan:XP_DatumAttribut/wert"/>
											</plu:ordinanceDate>
											<plu:ordinanceReference>
												<xsl:apply-templates select="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:hatGenerAttribut/xplan:XP_DatumAttribut/name"/>
											</plu:ordinanceReference>
										</plu:OrdinanceValue>
									</plu:ordinance>
								</xsl:when>
					...
					<!-- Setzt Verknüpfung für jedes existierende FP_TextAbschnitt-Element, für welches auf FP_Plan eine Relation über +texte besteht. Setzt nilReason falls keine Relation vorhanden ist-->
					<xsl:for-each select="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:texte">
						<plu:officialDocument xlink:href="{concat('#', 'GML_' , generate-id(.))}"/>
					</xsl:for-each>
					<xsl:if test="not(xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:texte)">
			...
			<!-- Setzt die gml:id äquivalent zum gesetzten xlink:href Attribut von texte von FP_Plan(hier auf # achten)-->
			<!-- Setzt die gml:id äquivalent zum gesetzten xlink:href Verweis von refTextInhalt des Objekts-->
			<xsl:variable name="texte" select="/xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:texte/@xlink:href"/>
			<xsl:for-each select="/xplan:XPlanAuszug/gml:featureMember/xplan:FP_TextAbschnitt">
				<!--Um nur mit SpatialPlan/xplan:FP_Plan verlinkte Dokumente zu finden: <xsl:for-each select="/xplan:XPlanAuszug/gml:featureMember/xplan:FP_TextAbschnitt[concat('#', @gml:id)=$texte]">-->
				<xsl:variable name="textabschnittid" select="concat('#',@gml:id)"/>
				<wfs:member>
					<plu:OfficialDocumentation>
						<!--Id für zum Plan gehörige Textabschnitte-->
						<xsl:for-each select="/xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:texte[@xlink:href=$textabschnittid]">
							<xsl:attribute name="gml:id">
								<xsl:value-of select="concat('GML_' , generate-id(/xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:texte[@xlink:href=$textabschnittid]))"/>
							</xsl:attribute>
						</xsl:for-each>
						...
						<plu:inspireId>
							<base:Identifier>
								<xsl:choose>
									<!-- zu Plan -->
									<xsl:when test="/xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:texte[@xlink:href=$textabschnittid]">
										<base:localId>
											<xsl:value-of select="concat('inspirelocalid_' , generate-id(/xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:texte[@xlink:href=$textabschnittid]))"/>
										</base:localId>
									</xsl:when>
									<!-- zu Objekt -->
									<xsl:otherwise>
						...
						<xsl:choose> 
							<xsl:when test="xplan:XPlanAuszug/gml:featureMember/FP_TextAbschnitt/xplan:refText/xplan:XP_ExterneReferenz/xplan:referenzName">
								<plu:legislationCitation>
									<base2:LegislationCitation>
										<base2:name>
											<xsl:apply-templates select="xplan:XPlanAuszug/gml:featureMember/FP_TextAbschnitt/xplan:refText/xplan:XP_ExterneReferenz/xplan:referenzName"/>
										</base2:name>
						...
						<!--plu:regulationText-->
						<xsl:choose> 
							<xsl:when test="xplan:XPlanAuszug/gml:featureMember/FP_TextAbschnitt/xplan:text">
								<plu:regulationText>
									<xsl:apply-templates select="xplan:XPlanAuszug/gml:featureMember/FP_TextAbschnitt/xplan:text"/>
								</plu:regulationText>
							</xsl:when>
							<xsl:otherwise>
						...
						<wfs:member>
							<plu:ZoningElement gml:id="{concat('GML_' , generate-id(.))}">
								...
								<xsl:choose>
									...
									<xsl:when test="xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan/xplan:rechtsstand=5000">
										<plu:processStepGeneral xlink:href="http://inspire.ec.europa.eu/codelist/ProcessStepGeneralValue/obsolete"/>
									</xsl:when>
									<xsl:otherwise>
										<plu:processStepGeneral nilReason="unknown" xsi:nil="true"/>
								...
								<plu:plan xlink:href="{concat('#', 'GML_', generate-id(/xplan:XPlanAuszug/gml:featureMember/xplan:FP_Plan))}"/>
							</plu:ZoningElement>
						</wfs:member>
					</xsl:when>
					<xsl:otherwise>
