BEGIN;
-- Fixes inheritance of bp_strassenverkehrsflaeche from bp_geometrieobjekt to bp_flaechenschlussobjekt
-- Removes null constraint from flaechenschluss bp_verkehrsflaechebesonderezweckbestimmung
-- Uses temporary tablenames to transfer data
...
(
  ...
  rechtsstand xplan_gml.xp_rechtsstand,
  gesetzlichegrundlage xplan_gml.xp_gesetzlichegrundlage,
  gliederung1 character varying,
  gliederung2 character varying,
  ebene integer,
  hatgenerattribut xplan_gml.xp_generattribut[],
  hoehenangabe xplan_gml.xp_hoehenangabe[],
  user_id integer,
  ...
  startbedingung xplan_gml.xp_wirksamkeitbedingung,
  endebedingung xplan_gml.xp_wirksamkeitbedingung,
  aufschrift character varying,
  rechtscharakter xplan_gml.bp_rechtscharakter NOT NULL,
  wirdausgeglichendurchspemassnahme text,
  wirdausgeglichendurchmassnahme text,
  wirdausgeglichendurchspeflaeche text,
...
-- VERKEHRSFLAECHEBESONDEREZWECKBESTIMMUNG
ALTER TABLE
