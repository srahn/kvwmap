...
-- DROP FUNCTION xplankonverter.check_bp_rechtsstand_datum_reference();
...
-- Part A
	...
	END IF;
-- Part B
	IF (new.rechtsstand = '2000'::xplan_gml.bp_rechtsstand AND (to_json(new.externereferenz)::text NOT LIKE '%"typ":"1010"%' OR new.externereferenz IS NULL)) THEN
		msg = msg || E'\nWenn der Rechtsstand Entwurf (2000) ausgewählt ist, muss mindestens ein Dokument mit dem Typ Begründung (1010) vorhanden sein.';
	ELSIF (new.rechtsstand = '2100'::xplan_gml.bp_rechtsstand AND (to_json(new.externereferenz)::text NOT LIKE '%"typ":"1010"%' OR new.externereferenz IS NULL)) THEN
		msg = msg || E'\nWenn der Rechtsstand Frühzeitige Behördenbeteiligung hat stattgefunden (2100) ausgewählt ist, muss mindestens ein Dokument mit dem Typ Begründung (1010) vorhanden sein.';
	ELSIF (new.rechtsstand = '2200'::xplan_gml.bp_rechtsstand AND (to_json(new.externereferenz)::text NOT LIKE '%"typ":"1010"%' OR new.externereferenz IS NULL)) THEN
		msg = msg || E'\nWenn der Rechtsstand Frühzeitige Beteiligung der Öffentlichkeit hat stattgefunden (2200) ausgewählt ist, muss mindestens ein Dokument mit dem Typ Begründung (1010) vorhanden sein.';
	ELSIF (new.rechtsstand = '2300'::xplan_gml.bp_rechtsstand AND (to_json(new.externereferenz)::text NOT LIKE '%"typ":"1010"%' OR new.externereferenz IS NULL)) THEN
		msg = msg || E'\nWenn der Rechtsstand Beteiligung der Behörden hat stattgefunden (2300) ausgewählt ist, muss mindestens ein Dokument mit dem Typ Begründung (1010) vorhanden sein.';
	ELSIF (new.rechtsstand = '2400'::xplan_gml.bp_rechtsstand AND (to_json(new.externereferenz)::text NOT LIKE '%"typ":"1010"%' OR new.externereferenz IS NULL)) THEN
		msg = msg || E'\nWenn der Rechtsstand Plan hat öffentlich ausgelegen (2400) ausgewählt ist, muss mindestens ein Dokument mit dem Typ Begründung (1010) vorhanden sein.';
	ELSIF (new.rechtsstand = '3000'::xplan_gml.bp_rechtsstand AND (to_json(new.externereferenz)::text NOT LIKE '%"typ":"1010"%' OR new.externereferenz IS NULL)) THEN
		msg = msg || E'\nWenn der Rechtsstand Satzung (3000) ausgewählt ist, muss mindestens ein Dokument mit dem Typ Begründung (1010) vorhanden sein.';
	ELSIF (new.rechtsstand = '4000'::xplan_gml.bp_rechtsstand AND (to_json(new.externereferenz)::text NOT LIKE '%"typ":"1010"%' OR new.externereferenz IS NULL)) THEN
		msg = msg || E'\nWenn der Rechtsstand in Kraft getreten (4000) ausgewählt ist, muss mindestens ein Dokument mit dem Typ Begründung (1010) vorhanden sein.';
	ELSIF (new.rechtsstand = '4500'::xplan_gml.bp_rechtsstand AND (to_json(new.externereferenz)::text NOT LIKE '%"typ":"1010"%' OR new.externereferenz IS NULL)) THEN
		msg = msg || E'\nWenn der Rechtsstand Plan ist teilweise untergegangen (4500) ausgewählt ist, muss mindestens ein Dokument mit dem Typ Begründung (1010) vorhanden sein.';
	ELSIF (new.rechtsstand = '5000'::xplan_gml.bp_rechtsstand AND (to_json(new.externereferenz)::text NOT LIKE '%"typ":"1010"%' OR new.externereferenz IS NULL)) THEN
		msg = msg || E'\nWenn der Rechtsstand Plan wurde aufgehoben oder für nichtig erklärt (5000) ausgewählt ist, muss mindestens ein Dokument mit dem Typ Begründung (1010) vorhanden sein.';
	END IF;
-- Part C
