		...
		switch ($go) {
			...
			case 'Layereditor_Speichern' : {
				...
				$GUI->sanitize([
					...
					'wms_server_version' => 'text',
					'wms_format' => 'text',
					'wms_connectiontimeout' => 'int',
					'wms_auth_username' => 'text',
					'wms_auth_password' => 'text',
					'wfs_geom' => 'text',
					'write_mapserver_templates' => 'text',
					'selectiontype' => 'text',
					'querymap' => 'boolean',
					'logconsume' => 'boolean',
					'processing' => 'text',
					...
					'datasource' => 'int',
					'dataowner_name' => 'text',
					'dataowner_email' => 'text',
					'dataowner_tel' => 'text',
					'uptodateness' => 'text',
					'updatecycle' => 'text',
					'metalink' => 'text',
					'terms_of_use_link' => 'text',
					'icon' => 'text',
					'privileg' => 'int',
					'export_privileg' => 'int',
					'status' => 'text',
					...
					'editable' => 'int',
					'listed' => 'int',
					'duplicate_from_layer_id' => 'int',
					'duplicate_criterion' => 'text',
					'shared_from' => 'int',
					'version' => 'text',
					'comment' => 'text',
					'vector_tile_url' => 'text',
					'cluster_option' => 'int',
					'ows_publication' => 'bool',
					'ows_mapfile_name' => 'text',
					'ows_wrapper_name' => 'text',
					'ows_stelle_id' => 'integer'
				]);
