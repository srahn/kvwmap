<html lang="de">
	...
	<body onload="onload_functions();">
		...
		<div id="header_menue"><?
			...
			<div id="layer_switch" title="Layerauswahl einschalten">
				<i id="layer_switch_icon" class="fa fa-navicon header-button" aria-hidden="true" style="font-size: 150%;" onclick="$('#layer_switch_icon').toggleClass('fa-navicon fa-times'); $('#legenddiv').toggle();"></i>
			</div><?
