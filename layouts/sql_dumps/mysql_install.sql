...
CREATE TABLE layer_attributes (
  ...
  form_element_type enum('Text','Textfeld','Auswahlfeld','Geometrie','SubFormPK','SubFormFK','SubFormEmbeddedPK','Time','Dokument','Link','User','Stelle','Fläche','dynamicLink','Zahl') NOT NULL default 'Text',
  options text,
...
CREATE TABLE rolle (
  ...
  gui varchar(25) collate latin1_german2_ci NOT NULL default 'gui.php',
