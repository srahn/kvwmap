<?
/**
 * Verwendete Variablen in diese Snippet:
 * $this->new_entry boolean: True wenn das Recht zum Editieren des Layers besteht und ein neuer Datensatz angelegt werden soll. Wird nur in $GUI->neuer_Layer_Datensatz gesetzt.
 * $this->fount boolean: Wenn vorher Objekte über die Layer-Suche gefunden wurden.
 * $this->search boolean:
 * $doit:
 * $dataset_operation_position (oben, unten, beide):
 */
				...
				><?php
					...
					<table class="tgle dstable" border="0" cellpadding="5" cellspacing="0"><?
						if (!$this->user->rolle->visually_impaired) {
							include(LAYOUTPATH . 'snippets/generic_layer_editor_2_layer_head.php');
						} ?>
