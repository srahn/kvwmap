...
?>
	<tr>
	  <td>
	    ...
	    <table id="dstable" class="tgle" style="width:100%; border-bottom: 1px solid grey" <? if($layer['attributes']['group'][0] != ''){echo 'border="0" cellpadding="6" cellspacing="0"';}else{echo 'border="1"';} ?>>
