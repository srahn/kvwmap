...
<?php
  ...
  if ($anzObj>0) {?>
	  ...
	  Anzahl der gefundenen Flurstücke: <?php echo $anzObj.'<br><br>';
...
?><tr>
    <td valign="top">
      <table border="0" cellspacing="0" cellpadding="2">
      	<tr>
      		<td colspan="2"></td>
      		<td rowspan="2" valign="bottom"><input type="checkbox" name="check_flurstueck" value="<?php echo $flst->FlurstKennz; ?>" checked>&nbsp;auswählen</td>
      	</tr>
...
<tr align="center" valign="top" bgcolor="<?php echo BG_DEFAULT ?>">
	...
	<tr>
		<td><b>Für alle ausgewählten Flurstücke:</b><br></td>
	</tr>
	<tr align="center" valign="top" bgcolor="<?php echo BG_DEFAULT ?>">
    <td colspan="2">
