						          	...
						          	<div id="maptime" style="padding: 2px">
													<table cellpadding="0" cellspacing="0">
														<tr>
															...
															<td style="padding: 0 0 0 10;"><a title="<? echo $strSaveExtent; ?>" href="index.php?go=Layerauswahl_Formular"><div class="button_background"><div class="emboss save_layers"><img src="<? echo GRAPHICSPATH.'leer.gif'; ?>"></div></div></a></td>
															<td style="padding: 0 0 0 10;"><a title="<? echo $strChoose ?>" href="index.php?go=Layerauswahl_Waehlen"><div class="button_background"><div class="emboss load_layers"><img src="<? echo GRAPHICSPATH.'leer.gif'; ?>"></div></div></a></td>
