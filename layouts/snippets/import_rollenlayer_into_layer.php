...
<table border="0" cellpadding="5" cellspacing="3" bgcolor="<?php echo $bgcolor; ?>">
  ...
  <tr>
  	...
  	<td valign="top" align="center" colspan="2" style="padding: 10px">
			<div class="fett" style="padding: 5px; white-space: nowrap; text-overflow: ellipsis; width: 200px; overflow: hidden;"><? echo $this->rollenlayer[0]['name'] ?></div>
  	...
  	<td valign="top" align="center" colspan="2" style="padding: 10px">
			<div class="fett" style="padding: 5px; white-space: nowrap; text-overflow: ellipsis; width: 200px; overflow: hidden;"><? echo $this->layer[0]['name'] ?></div>
