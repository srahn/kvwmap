				...
				<tr>
					<td align="center">
						<table cellspacing="0" cellpadding="2" border="0">
							...
							<tr>
								<td colspan="2">Herzlich Willkommen zur Registrierung am <? echo TITLE; ?>.<p><?
									echo $this->invitation->inviter->get('Vorname') . ' ' . $this->invitation->inviter->get('Name'); ?> hat Sie zur Mitarbeit in der Arbeitsstelle <? echo $this->invitation->stelle->get('bezeichnung'); ?> eingeladen.<br>Vergeben Sie bitte einen Benutzername und Passwort und<br>passen Sie ggf. Ihre Kontaktdaten an. Nach erfolgreicher Registrierung<br>können Sie direkt in der Web-Anwendung <? echo TITLE; ?> arbeiten.<p>
									...
									if ($this->invitation->inviter->get('phon') != '') { ?>
										<br>oder rufen an unter der Telefonnummer <? echo $this->invitation->inviter->get('phon') . '.';
									} ?>
								</td>
							</tr><?
							...
							<tr>
								...
								<td>
									<input style="width: 130px" type="text" value="<? echo $this->formvars['Name']; ?>" name="Name" />
								</td>
							</tr>
							<tr>
								<td><span class="px16">Vorname: </span></td>
								<td>
									<input style="width: 130px" type="text" value="<? echo $this->formvars['Vorname']; ?>" name="Vorname" />
								</td>
							</tr>
							<tr>
								<td><span class="px16">Namenszusatz: </span></td>
								<td>
									<input style="width: 130px" type="text" value="<? echo $this->formvars['Namenszusatz']; ?>" name="Namenszusatz" />
								</td>
							</tr>
							<tr>
								<td><span class="px16">Nutzername: *</span></td>
								<td>
									<input style="width: 130px" type="text" value="<? echo $this->formvars['login_name']; ?>" name="login_name" />
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<input style="width: 130px" type="text" value="<? echo $this->formvars['phon']; ?>" name="phon" />
								</td>
							</tr>
							<tr>
