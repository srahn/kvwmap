				...
				<tr>
					<td align="center">
						...
						if ($this->menue->get('id') > 0) { ?>
							...
							<input value="Zurücksetzen" title="Setzt alle Werte zurück auf die vorhigen." type="button" onclick="document.location.href='index.php?go=Menueeditor&selected_menue_id=<?php echo  $this->menue->get('id'); ?>'">&nbsp;<?
						} ?>
