...
nav label:active { background: #c3d3e6; }
...
<div id="rollenwahl_optionen_div" class="tabbed">
	...
	<nav>
		<label for="tab1"><? echo $strGeneralOptions; ?></label>
		<label for="tab2"><? echo $strGeneralOptions; ?></label>
		<label for="tab3"><? echo $strButtons; ?></label>
		<label for="tab4"><? echo $strMapOptions; ?></label>
		<label for="tab5"><? echo $strDataPresentation; ?></label>
	</nav>

	<figure>
		<div id="layer_parameters_div tab1"><?
