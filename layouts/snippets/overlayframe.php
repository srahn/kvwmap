...
?>
				<form name="GUI2" enctype="multipart/form-data" method="post" action="index.php" id="GUI2">
					<div id="overlaydiv" style="display:none;padding:3px;left:150px;top:150px;width:auto;max-width:<? echo $width; ?>px;position:absolute;z-index: 1000;-moz-box-shadow: 12px 10px 14px #777;-webkit-box-shadow: 12px 10px 14px #777;box-shadow: 12px 10px 14px #777;">
						...
						<div align="right" style="display:flex;cursor:default; background-color:<? echo BG_DEFAULT; ?>; border: 1px solid #cccccc;position:relative;">
							<div id="dragdiv" align="right" onmousedown="dragstart(document.getElementById('overlaydiv'))" style="min-width: 70px;width: 100%"></div>
							<div>
								<a href="javascript:minimize_overlay();" id="minmaxlink" title="Minimieren"><img style="border:none" src="<? echo GRAPHICSPATH."minimize.png"; ?>"></img></a>
							</div>
							<div>
