...
<div id="legend_layer">
	...
	<div id="legendcontrol">
		...
		<input type="submit" name="neuladen_button" onclick="if(checkForUnsavedChanges()){startwaiting(true);document.GUI.go.value='neu Laden';}" value="<?php echo $strLoadNew; ?>" tabindex="1" style="vertical-align: top; margin-left: 25px">			
	</div>
