<?php
 # 2008-01-22 pkvvm
  include(LAYOUTPATH.'languages/shape_import_'.rolle::$language.'.php');
 ?>
...
<table border="0" cellpadding="5" cellspacing="3" bgcolor="<?php echo $bgcolor; ?>">
  ...
  <tr>
  	<td>&nbsp;</td>
		...
		<input type="file" name="ukofile" size="12">
		<td>&nbsp;</td>
	</tr>
	<tr align="center">
		<td>&nbsp;</td>
	...
	<tr>
		<td colspan="3" align="center"><input type="button" name="import" onclick="save();" value="Importieren"></td></td>
	</tr>
	<? }else{ ?>
	<tr>
		<td>&nbsp;</td>
