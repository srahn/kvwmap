					...
					<td align="center">
						<table cellspacing="0" cellpadding="2" border="0">
							...
							<tr>
								...
								<td><input id="login_name" style="width: 130px; height: 25px;" type="text" value="<? echo htmlspecialchars($this->formvars['login_name']); ?>" name="login_name"/></td>
							</tr>
							<tr>
								<td><span class="px16">Passwort:</span></td>
								<td><input style="width: 130px; height: 25px;" type="password" value="" id="passwort" name="passwort" /><i style="margin-left: -18px" class="fa fa-eye-slash" aria-hidden="true" onclick="$(this).toggleClass('fa-eye fa-eye-slash'); if ($('#passwort').attr('type') == 'text') { $('#passwort').attr('type', 'password') } else { $('#passwort').attr('type', 'text'); }"></i></td>
							</tr>
							<tr>
