...
<table width="760" border="0" cellpadding="5" cellspacing="0" bgcolor="<?php echo $bgcolor; ?>">
  ...
  <tr> 
    <td align="center"><input type="button" name="senden2" value="<? echo $strSaveWithoutZoom; ?>" onclick="send('false');"><br><br><input type="button" value="zur¸nclick="window.open('http://62.52.0.125/kvwmap/index.php?go=Layer-Suche&go_plus=Suchen&selected_layer_id=<?php echo $this->formvars['selected_layer_id']; ?>&value_<?php echo $this->formvars['layer_tablename']; ?>_oid=<?php echo $this->formvars['oid']; ?>')"><input type="button" name="senden" value="<? echo $strSave; ?>" onclick="send('true');"></td>
  </tr>
  <? }else{ ?>
  <tr>
  	<td></td>
