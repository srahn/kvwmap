				...
				<tr>
					...
					<td height="23" colspan="3">
						...
						<select style="width:170px" name="chartvalue_<?php echo $this->qlayerset[$i]['Layer_ID']; ?>" onchange="create_chart(<?php echo $this->qlayerset[$i]['Layer_ID']; ?>);">
							...
							<?
							for($j = 0; $j < count($this->qlayerset[$i]['attributes']['name']); $j++){
								if($this->qlayerset[$i]['attributes']['name'][$j] != $this->qlayerset[$i]['attributes']['the_geom'] AND $this->qlayerset[$i]['attributes']['name'][$j] != 'gemname' AND $this->qlayerset[$i]['attributes']['name'][$j] != 'geschlecht' AND $this->qlayerset[$i]['attributes']['name'][$j] != 'amtname'){
