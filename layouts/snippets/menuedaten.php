		...
		<td>
			<table width="100%" border="0" cellspacing="0" cellpadding="2">
				<tr>
					...
					<th colspan="2"><a href='index.php?go=Menues_Anzeigen&view_sort=obermenue,"order"&sort_direction=<?php echo $this->formvars['sort_direction']; ?>&csrf_token=<? echo $_SESSION['csrf_token']; ?>'><? echo $strTopMenue . ' ' . $this->strAnd . ' ' . $strMenueOrder; ?></a><br><a href="index.php?go=Menues_Anzeigen&view_sort=menueebene,name&csrf_token=<? echo $_SESSION['csrf_token']; ?>"><? echo $strMenueLevel . ' ' . $this->strAnd . ' ' . $this->strName; ?></a></td>
				</tr><?php
