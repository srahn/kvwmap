	...
	<table width="100%" border="0" cellpadding="2" cellspacing="0">
		<tr align="right"> 
	  	<td height="30" valign="middle">
	  		<input type="button" tabindex="1" name="go_plus" id="go_plus" value="<? echo $strSave; ?>" onclick="subsave_new_layer_data(<? echo $this->formvars['selected_layer_id']; ?>, '<? echo $this->formvars['fromobject'] ?>', '<? echo $this->formvars['targetobject'] ?>', '<? echo $this->formvars['targetlayer_id'] ?>', '<? echo $this->formvars['targetattribute'] ?>', '<? echo $this->formvars['reload'] ?>', '<? echo $this->formvars['list_edit'] ?>');">
