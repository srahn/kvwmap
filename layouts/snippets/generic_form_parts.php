...
function attribute_name($layer_id, $attributes, $j, $fontsize){
	$datapart .= '<table ';
...
function attribute_value(&$gui, $layer_id, $attributes, $j, $k, $dataset, $size, $fontsize){
	global $strShowPK;
	global $strNewPK;
	global $strShowFK;
	global $strShowAll;
