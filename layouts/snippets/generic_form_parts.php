				...
				case 'Radiobutton' : {
					...
					if($attribute_privileg == '0' OR $lock){
						...
						for($e = 0; $e < count($enum_value); $e++){
							...
							if($attributes['nullable'][$j] != '0')$datapart .= ' onclick="this.checked = this.checked2;" onmouseup="this.checked = this.checked2;" onmousedown="this.checked = !this.checked; this.checked2 = this.checked; this.onchange();"';
