...
<table border="0" cellspacing="0" cellpadding="2">
  <tr>
    <td align="center">
      <h2><?php echo $strTitleLayers; ?></h2><br>
    </td>
  </tr>
  <tr>
    <td align="center">
      <textarea name="comment" cols="35" autofocus rows="4" wrap="VIRTUAL"><?php echo $this->formvars['comment']; ?></textarea><br>
      <input type="hidden" name="go" value="Layerauswahl">
  ...
  <tr> 
    ...
    <td>
      <div id="legenddiv" style="border: none; width:230; height:<?php echo $this->map->height; ?>; overflow:auto; scrollbar-base-color:<?php echo BG_DEFAULT ?>">
        <? echo $this->legende; ?>
      </div>
    </td>
  </tr>
