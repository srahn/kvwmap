				...
				<div style="width:190px;" onmouseover="document.getElementById('scales').style.display='inline-block';" onmouseout="document.getElementById('scales').style.display='none';">
					...
					<div valign="top" style="height:0px; position:relative;">
						<div id="scales" style="z-index: 1;display:none; position:absolute; left:98px; top:-1px; width: 78px; vertical-align:top; overflow:hidden; border:solid grey 1px;">
							<select size="<? echo count($this->selectable_scales); ?>" style="padding:4px; margin:-2px -17px -4px -4px;" onmousedown="if(!this.value){event.stopPropagation();}else{if(document.GUI.printscale.value != this.value){document.GUI.printscale.value=this.value; document.getElementById('scales').style.display='none';setprintextent('false');}}" onclick="document.GUI.printscale.value=this.value; document.getElementById('scales').style.display='none';setprintextent('false');">  <!-- diese Kopfstaende mit den Events haben wir dem IE und Edge zu verdanken -->
								<? 
