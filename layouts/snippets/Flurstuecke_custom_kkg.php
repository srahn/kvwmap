...
function kkg_export(option){
  var semi = false;
  var flurstkennz = "";
  var areas = "";
  var areaarray = document.getElementsByName("area_flurstueck");
 	var flurstarray = document.getElementsByName("check_flurstueck");
  for(i = 0; i < flurstarray.length; i++){
    if(flurstarray[i].checked == true){
      if(semi == true){
      ...
      flurstkennz += flurstarray[i].value;
      areas += areaarray[i].value;
      semi = true;
    }
  }
  if(option == 'F'){
		new_window = window.open("kkg://"+option+"_"+areas, "", "");
	}
	else{
  	new_window = window.open("kkg://"+option+"_"+flurstkennz, "", "");
  }
  new_window.close();
}
...
?>
    ...
    <div style="position:relative; top:0px; right:0px; padding:=px; border-color:<?php echo BG_DEFAULT ?>; border-width:1px; border-style:solid;">
      ...
      <tr>
        <td valign="top">
          ...
          <input type="hidden" name="area_flurstueck" value="<?php echo $flst->ALB_Flaeche; ?>">
        </td>
        <td>
      <table border="0" cellspacing="0" cellpadding="0">
        <tr>
  ...
  <tr>
    ...
    <tr align="center" valign="top" bgcolor="<?php echo BG_DEFAULT ?>">
    	<td>
		    <a href="javascript:kkg_export('0');"><img src="<? echo GRAPHICSPATH; ?>KKGDatenAktuell_lc.gif" alt="Suchen im aktuellen KKG Projekt" title="Suchen im aktuellen KKG Projekt" border="no"></a>&nbsp;&nbsp;
		    <a href="javascript:kkg_export('1');"><img src="<? echo GRAPHICSPATH; ?>MeineAktuellen_lc.gif" alt="Suchen in allen meinen aktuellen Projekten" title="Suchen in allen meinen aktuellen Projekten" border="no"></a>&nbsp;&nbsp;
		    <a href="javascript:kkg_export('2');"><img src="<? echo GRAPHICSPATH; ?>MirZugeordnet_lc.gif" alt="Suchen in mir zugeordneten Projekten" title="Suchen in mir zugeordneten Projekten" border="no"></a>&nbsp;&nbsp;
		    <a href="javascript:kkg_export('3');"><img src="<? echo GRAPHICSPATH; ?>AlleAktiven_lc.gif" alt="Suchen in allen aktiven Projekten" title="Suchen in allen aktiven Projekten" border="no"></a>&nbsp;&nbsp;
		    <a href="javascript:kkg_export('4');"><img src="<? echo GRAPHICSPATH; ?>AlleProjekte_lc.gif" alt="Suchen in allen KKG Projekten" title="Suchen in allen KKG Projekten" border="no"></a>&nbsp;&nbsp;
		    <a href="javascript:kkg_export('F');"><img src="<? echo GRAPHICSPATH; ?>KKG_24x23_flaeche.gif" alt="&Uuml;bermittlung Flurst&uuml;cksfl&auml;che an KKG" title="&Uuml;bermittlung Flurst&uuml;cksfl&auml;che an KKG" border="no"></a>
	  	</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
...
?>
  ...
  <a href="javascript:backto('Grundbuchblatt_Auswaehlen_Suchen');">zurück zur Grundbuchblattsuche</a>
  <br><br>
<?}
