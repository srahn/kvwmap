    ...
    <div style="position:relative; top:0px; right:0px; padding:=px; border-color:<?php echo BG_DEFAULT ?>; border-width:1px; border-style:solid;">
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        ...
        <td colspan="2">
            ...
            $flst->Buchungen=$flst->getBuchungen($flst->Grundbuecher[$g]['bezirk'],$flst->Grundbuecher[$g]['blatt']);
...
-->       <tr align="center" valign="top" bgcolor="<?php echo BG_DEFAULT ?>">
          ...
          <a href="index.php?go=ALB_Anzeige&FlurstKennz=<?php echo $flst->FlurstKennz; ?>&formnummer=30&wz=0" target="_blank">ALB-Auszug&nbsp;30&nbsp;(Flurst&uuml;cke)</a>
          <?php } ?>
          <?php
          if ($this->Stelle->funktionen['ALB-Auszug 35']['erlaubt'] AND $this->Stelle->funktionen['ohneWasserzeichen']['erlaubt']) { ?>
          | <a href="index.php?go=ALB_Anzeige&FlurstKennz=<?php echo $flst->FlurstKennz; ?>&formnummer=35&wz=0" target="_blank">ALB-Auszug&nbsp;35&nbsp;(Flurst&uuml;cke/Eigent&uuml;mer)</a>
          <?php }
          if ($this->Stelle->funktionen['ALB-Auszug 40']['erlaubt'] AND $this->Stelle->funktionen['ohneWasserzeichen']['erlaubt']) { ?>
          | <a href="index.php?go=ALB_Anzeige&FlurstKennz=<?php echo $flst->FlurstKennz; ?>&formnummer=40&wz=0" target="_blank">ALB-Auszug&nbsp;40&nbsp;(Eigent&uuml;mer)</a>
          <?php } ?>
        <? } ?>
        </td>
        </tr>
...
-->      <tr align="center" valign="top" bgcolor="<?php echo BG_DEFAULT ?>">
          <td colspan="2">
            ...
            $this->getFunktionen();
            if ($this->Stelle->funktionen['ohneWasserzeichen']['erlaubt']) { ?>
                <a href="javascript:send_selected_flurst('index.php?go=ALB_Anzeige&formnummer=30&wz=0', '_blank');">ALB-Auszug&nbsp;30&nbsp;(Flurst&uuml;cke)</a>
            <?php } ?>
            <?php
            if ($this->Stelle->funktionen['ALB-Auszug 35']['erlaubt'] AND $this->Stelle->funktionen['ohneWasserzeichen']['erlaubt']) { ?>
                | <a href="javascript:send_selected_flurst('index.php?go=ALB_Anzeige&formnummer=35&wz=0', '_blank');">ALB-Auszug&nbsp;35&nbsp;(Flurst&uuml;cke/Eigent&uuml;mer)</a>
            <?php }
            if ($this->Stelle->funktionen['ALB-Auszug 40']['erlaubt'] AND $this->Stelle->funktionen['ohneWasserzeichen']['erlaubt']) { ?>
                | <a href="javascript:send_selected_flurst('index.php?go=ALB_Anzeige&formnummer=40&wz=0', '_blank');">ALB-Auszug&nbsp;40&nbsp;(Eigent&uuml;mer)</a>
            <?php } ?>
          </td>
      </tr>
    <? } ?>
...
-->        <? if($flst->Status != 'H'){ ?><!--&nbsp;|&nbsp;--><a href="javascript:send_selected_flurst('index.php?go=ZoomToFlst', '');">Kartenausschnitt</a><? } ?>
        </td>
    </tr>
    <tr>
      <td>&nbsp;</td>
...
?>
  ...
  <a href="javascript:backto_gbsearch();">zurück zur Grundbuchblattsuche</a>
  <br><br>
<?}
