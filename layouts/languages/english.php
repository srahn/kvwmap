<?
	...
	$this->strNo = 'No';
	$this->strNoMapPrintFrame = "There are no map print frames in this working group. Create a new one if you have the permissions with menue Print manager > Map print frame editor and assign it to this working group. Otherwise inform the administrator of this application!";
