<?php
	$strAccessConstraints = 'Zugangsbeschränkungen (ows_accessconstraints)';
	$strActiveLayer = 'nur die gerade eingeschalteten';
	$strAll = 'alle Layer der Stelle';
	$strAllOrActiveLayer = 'Welche Layer der Stelle sollen im Dienst ausgegeben werden?';
