...
$strAndOrHint="Interrogate a search criterion (or multiple) for several times.\nLink up the criterions of your query by using 'or' and accordingly 'and'.\n\nLinking up with _or_ means that one of the two conditions needs to be fulfilled ('Either condition X from the first request or condition X from the second request').\n\nLinking up with _and_ means that all conditions need to be true ('Both condition X from the first request and condition X from the second request').";
