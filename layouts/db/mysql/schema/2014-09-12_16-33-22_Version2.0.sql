...
CREATE TABLE `u_groups` (
  ...
  `Gruppenname` varchar(255) NOT NULL,
	`Gruppenname_low-german` VARCHAR( 100 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL,
	`Gruppenname_english` VARCHAR( 100 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL,
	`Gruppenname_polish` VARCHAR( 100 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL,
	`Gruppenname_vietnamese` VARCHAR( 100 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL,
...
CREATE TABLE classes (
  ...
  Name varchar(50) NOT NULL default '',
	`Name_low-german` VARCHAR( 100 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL,
	`Name_english` VARCHAR( 100 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL,
	`Name_polish` VARCHAR( 100 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL,
	`Name_vietnamese` VARCHAR( 100 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL,
...
CREATE TABLE stelle (
  ...
  `Bezeichnung_low-german` VARCHAR( 255 ) NULL,
  `Bezeichnung_english` VARCHAR(255) CHARACTER SET cp1250 COLLATE cp1250_general_ci NULL,
  `Bezeichnung_polish` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL,
  `Bezeichnung_vietnamese` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL,
...
CREATE TABLE u_menues (
  id int(11) NOT NULL auto_increment,
  `name` varchar(100) NOT NULL default '',
  `name_low-german` VARCHAR(100) NULL,
  `name_english` VARCHAR(100) CHARACTER SET cp1250 COLLATE cp1250_general_ci NULL,
  `name_polish` VARCHAR( 100 ) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL,
  `name_vietnamese` VARCHAR(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL,  
