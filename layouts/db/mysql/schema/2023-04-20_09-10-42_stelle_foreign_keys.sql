...
delete from `ddl2stelle` where `stelle_id` not in (select ID from stelle);
...
delete from `invitations` where `stelle_id` not in (select ID from stelle);
...
delete from `u_menue2stelle` where `stelle_id` not in (select ID from stelle);
...
delete from `rolle` where user_id not in (select ID from `user`);
...
DELETE FROM `layer_attributes2rolle` WHERE concat(`stelle_id`, '_', `layer_id`, '_', `attributename`) NOT in (select concat(`stelle_id`, '_', `layer_id`, '_', `attributename`) from layer_attributes2stelle);
DELETE FROM `layer_attributes2rolle` WHERE concat(`stelle_id`, '_', `user_id`) NOT in (select concat(`stelle_id`, '_', `user_id`) from rolle);
...
DELETE FROM `rollenlayer` WHERE concat(`stelle_id`, '_', `user_id`) NOT in (select concat(`stelle_id`, '_', `user_id`) from rolle);
...
DELETE FROM `rolle_csv_attributes` WHERE concat(`stelle_id`, '_', `user_id`) NOT in (select concat(`stelle_id`, '_', `user_id`) from rolle);
...
DELETE FROM `rolle_last_query` WHERE concat(`stelle_id`, '_', `user_id`) NOT in (select concat(`stelle_id`, '_', `user_id`) from rolle);
...
DELETE FROM `rolle_saved_layers` WHERE concat(`stelle_id`, '_', `user_id`) NOT in (select concat(`stelle_id`, '_', `user_id`) from rolle);
...
DELETE FROM `search_attributes2rolle` WHERE concat(`stelle_id`, '_', `user_id`) NOT in (select concat(`stelle_id`, '_', `user_id`) from rolle);
...
DELETE FROM `u_groups2rolle` WHERE concat(`stelle_id`, '_', `user_id`) NOT in (select concat(`stelle_id`, '_', `user_id`) from rolle);
...
DELETE FROM `u_menue2rolle` WHERE concat(`stelle_id`, '_', `user_id`) NOT in (select concat(`stelle_id`, '_', `user_id`) from rolle);
...
DELETE FROM `u_rolle2used_class` WHERE concat(`stelle_id`, '_', `user_id`) NOT in (select concat(`stelle_id`, '_', `user_id`) from rolle);
...
DELETE FROM `u_rolle2used_layer` WHERE concat(`stelle_id`, '_', `user_id`) NOT in (select concat(`stelle_id`, '_', `user_id`) from rolle);
...
DELETE FROM `zwischenablage` WHERE concat(`stelle_id`, '_', `user_id`) NOT in (select concat(`stelle_id`, '_', `user_id`) from rolle);
