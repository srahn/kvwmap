...
('DEFAULT_DRUCKRAHMEN_ID', '', '42', 'Standarddrucklayout für den schnellen Kartendruck						# Version 1.7.4\r\n', 'numeric', 'Administration', '', 1, 2),
...
('WMS_MAPFILE_PATH', 'INSTALLPATH.WMS_MAPFILE_REL_PATH', 'INSTALLPATH.WMS_MAPFILE_REL_PATH', '', 'string', 'OWS-METADATEN', '', 1, 3),
('SUPORTED_WMS_VERSION', '', '1.0.0', '', 'string', 'OWS-METADATEN', '', 1, 2),
...
('MS_DEBUG_LEVEL', '', '0', 'Legt den Debug-Level für MapServer fest. Werte von 0 bis 5 sind möglich.', 'integer', 'Logging', 0, 2),
('IMPORT_POINT_STYLE_ID', '', '', 'Hier kann ein eigener Style für den Datenimport von Punkt-Objekten eingetragen werden.', 'integer', 'Layout', 0, 2);
