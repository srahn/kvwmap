...
function install_config() {
  ...
  $config = str_replace("define(MYSQL_HOST, 'localhost');", "define(MYSQL_HOST, getenv('MYSQL_PORT_3306_TCP_ADDR'));", $config);
  ...
  $config = str_replace("define(POSTGRES_HOST, 'localhost');", "define(POSTGRES_HOST, getenv('PGSQL_PORT_5432_TCP_ADDR'));", $config);
  $config = str_replace("define(POSTGRES_HOST_USER, '');", "define(POSTGRES_HOST_USER, 'kvwmap');", $config);
  $config = str_replace("define(POSTGRES_HOST_PASSWORD, '');", "define(POSTGRES_HOST_PASSWORD, 'kvwmap');", $config);
