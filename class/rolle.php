    ...
    # Abfragen der Layer in der Rolle
		...
		$sql = "
			SELECT " .
				$name_column . ",
				l.Layer_ID,
				alias, Datentyp, Gruppe, pfad, maintable, maintable_is_view, Data, tileindex, `schema`, document_path, document_url, l.labelitem, connection, printconnection,
...
# 2006-03-20 pk
  function setConsumeActivity($time,$activity,$prevtime) {
    ...
    $sql ="SELECT l.*, 4 as tolerance, -l.id as Layer_ID, l.query as pfad, 1 as queryable FROM rollenlayer AS l";
